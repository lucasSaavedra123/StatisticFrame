...
if __name__ == '__main__':
    #save_plots_against_target_variable('indexProcessed.csv', 'Volume')
    #save_plots_against_target_variable('50_Startups.csv', 'Profit')
    #save_plots_against_target_variable('gold_1979-2021.csv', 'United States(USD)')
    save_plots_against_target_variable('framingham.csv', 'TenYearCHD')
